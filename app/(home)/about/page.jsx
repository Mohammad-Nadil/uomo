    ...
    <section id="about">
      <Container>
        ...
        <div className="max-w-5xl mx-auto text-center mb-10">
          <h2 className="text-lg font-semibold uppercase mb-4">Our Story</h2>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
          ...
          <div>
            <h2 className="font-semibold uppercase mb-4">The Company</h2>
        ...
        <div className="grid md:grid-cols-3 gap-10 border-t py-10">
